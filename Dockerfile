...
# docker build -t catcatch/backend-$RANDOM --build-arg GOOGLE_OAUTH_CLIENT_ID=$GOOGLE_OAUTH_CLIENT_ID   --build-arg GOOGLE_OAUTH_CLIENT_SECRET=$GOOGLE_OAUTH_CLIENT_SECRET   --build-arg GOOGLE_OAUTH_REDIRECT_URI=$GOOGLE_OAUTH_REDIRECT_URI   --build-arg GOOGLE_OAUTH_DEFAULT_SCOPE=$GOOGLE_OAUTH_DEFAULT_SCOPE .